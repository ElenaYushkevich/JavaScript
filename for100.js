...
for (let i = 1; i <= 100; i++) { 
    if (i % 3 == 0 && i % 5 == 0) {console.log("число", i,"делится на три и на пять")} 
    else if (i % 3 == 0) {console.log("число", i,"делится на три")}
    else if (i % 5 == 0) {console.log("число", i,"делится на пять")}
    else  console.log("число", i);
}